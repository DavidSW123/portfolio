    ...
    <DashboardLayout role="PROVIDER" userName={session.name} userEmail={session.email}>
      <div className="space-y-8">
        ...
        <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-800">
          <strong>Información:</strong> Los coches que añadas pasarán por un proceso de revisión antes de publicarse.
          El administrador podrá ajustar el precio final. El margen aplicado por defecto es del 30%.
        </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              <Link href="/provider/cars" className="flex items-center gap-1 text-xs text-blue-600 hover:underline">
          ...
          <CardContent className="p-0">
            {myCars.length === 0 ? (
              <div className="py-10 text-center">
                ...
                <Link href="/provider/add-car" className="mt-3 inline-block">
